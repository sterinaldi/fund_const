...
This code implements the two inferences described in Rinaldi et al (in preparation). To run it, simply use the command `source run_inference.sh`. This is expected to complete in o(20 minutes).
